...
* link:https://github.com/creator-assertions/endorsement-assertion/issues[File an issue for discussion]
* link:https://github.com/creator-assertions/endorsement-assertion/pulls[File a pull request (suggested revision)]
